---
title: Installation
description: Getting started with componentcraftui
icon: ListStart
---
...
```bash tab="bun"
bunx shadcn@latest add https://ui.componentcraft.dev/r/utils.json 
```
 
```bash tab="npx"
npx shadcn@latest add https://ui.componentcraft.dev/r/utils.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://componentcraftui/r/utils.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://ui.componentcraft.dev/r/card-card-05.json
```
 
```bash tab="npx"
npx shadcn@latest add https://ui.componentcraft.dev/r/card-card-05.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ui.componentcraft.dev/r/card-card-05.json
```
...
```jsx
import Card05 from "@/components/componentcraftui/card-05";
...
```bash tab="bun"
bunx shadcn@latest add https://ui.componentcraft.dev/r/ai-card-generation-ai-card-generation.json
```
 
```bash tab="npx"
npx shadcn@latest add https://ui.componentcraft.dev/r/ai-card-generation-ai-card-generation.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ui.componentcraft.dev/r/ai-card-generation-ai-card-generation.json
```
 ...
 */
import AICardGeneration from "@/components/componentcraftui/AICardGeneration";
...
```bash tab="bun"
bunx shadcn@latest add https://ui.componentcraft.dev/r/card-card-05.json -c ./apps/www
```
 
```bash tab="npx"
npx shadcn@latest add https://ui.componentcraft.dev/r/card-card-05.json -c ./apps/www
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ui.componentcraft.dev/r/card-card-05.json -c ./apps/www
```
