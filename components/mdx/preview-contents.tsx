...
export default function PreviewContent({link,prePath,isBlock = false,}: {
    link: string;
    prePath: string;
    isBlock?: boolean;
}) {
    ...
    const handleCopyClick = async () => {
        ...
        // link.split("/") converts "docs/readme.md" → ["docs", "readme.md"].
        // Using array destructuring, folder = "docs" and filename = "readme.md".
        ...
        startTransition(async () => {
            ...
            // FormData is a browser API for sending key-value pairs to a server (commonly used in file uploads or POST requests).
            //   Here, you’re adding:
            //   folder: "docs"
            //   fileName: "readme.md"
